    var TableEditable04 = function () {

    var handleTable04 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            var price = aData[1].split("£")
             price = price[1].trim();

            jqTds[1].innerHTML = '<input class="form-control common_number_decimal" value="' + price + '">';
        ...
        var tableWrapper = $("#sample_editable_04_wrapper");
