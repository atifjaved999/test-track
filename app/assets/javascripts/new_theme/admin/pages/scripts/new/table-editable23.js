var TableEditable23 = function () {

    var handleTable23 = function () {
        ...
        var tableWrapper = $("#sample_editable_23_wrapper");
        ...
        $('#sample_editable_23_new').click(function (e) {
            e.preventDefault();
        ...
        function updateRowInDB(name, id){
            $.ajax({
                  url: '/admin/ingredient_units/'+id,
                  data: {"name": name},
                  method: 'PUT',
                  success: function(data) {
        ...
        function validate_data(inputs){
            if(inputs[0].value){
             return true;
            }else {
                console.log(inputs[0]);
                a = inputs[0];
                $(a).parent().attr('data-original-title', 'Blank Field');
                $(a).parent().trigger('mouseover');
                return false;
            }
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                if (!errors){
                    ...
                    var type_id = aData[3]
                    if (!type_id) {
                        saveRowInDB(jqInputs[0].value);
                    } 
                    else {
                        updateRowInDB(jqInputs[0].value, type_id);
                    }
