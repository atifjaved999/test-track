var TableEditable01 = function () {

    var handleTable01 = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[1].innerHTML = '<div class="input-inline input-medium"><input class="form-control common_number" value="' + aData[1] + '"></div>';
        ...
        var tableWrapper = $("#sample_editable_01_wrapper");
