var TableEditable30 = function () {

    var handleTable30 = function () {
        ...
        var tableWrapper = $("#sample_editable_30_wrapper");
        ...
        $('#sample_editable_30_new').click(function (e) {
            e.preventDefault();
        ...
        $(".edit-data").click(function(){
            id = $(this).data('id');
             $.ajax({
              url: "/admin/batch_recipes/" + id + "/edit",
              method: "get",
              success: function(data) {
                $("#dd").html(data);
