var TableEditable21 = function () {

    var handleTable21 = function () {
        ...
        var tableWrapper = $("#sample_editable_21_wrapper");
        ...
        $('#sample_editable_21_new').click(function (e) {
            e.preventDefault();
        ...
        // });
        function edit_data_supplier(id)
        {
            $.ajax({
