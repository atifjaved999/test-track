var TableEditable16 = function () {

    var handleTable16 = function () {
        ...
        var tableWrapper = $("#sample_editable_16_wrapper");
        ...
        $('#sample_editable_16_new').click(function (e) {
            e.preventDefault();
        ...
        function saveRowInDB(name, content){
            $.ajax({
                  url: '/admin/sms_templates',
        ...
        function updateRowInDB(name, content, id){
            $.ajax({
                  url: '/admin/sms_templates/'+id,
                  data: {"name": name,  "content" : content},
                  method: 'PUT',
                  success: function(data) {
                    alert("Updated..!!");
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                if (!errors){
                    ...
                    if (!temp_id) {
                        ...
                        updateRowInDB(jqInputs[0].value, jqInputs[1].value, temp_id);
                    }
                    // Magic ends
                }
