var ComponentsFormTools = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        var countries = new Bloodhound({
          ...
          limit: 10,
          prefetch: {
            url: '//assets/new_theme/admin/pages/scripts/demo/typeahead_countries.json',
        ...
        var nba = new Bloodhound({
          ...
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: '/assets/new_theme/admin/pages/scripts/demo/typeahead_nba.json'
        });
         
        var nhl = new Bloodhound({
          datumTokenizer: function(d) { return Bloodhound.tokenizers.whitespace(d.team); },
          queryTokenizer: Bloodhound.tokenizers.whitespace,
          prefetch: '/assets/new_theme/admin/pages/scripts/demo/typeahead_nhl.json'
        });
    ...
    var handleBootstrapTouchSpin = function() {
        ...
        $(".common_number").TouchSpin({          
          ...
          $(".common_number_decimal").TouchSpin({
            buttondown_class: 'btn red',
            buttonup_class: 'btn blue',
            min: 0,
            max: 10000000000,
